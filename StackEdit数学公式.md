...
Hexo博文的编写主要基于**Markdown**语言。**StackEdit**作为一款在线**Markdown**编写程序，有强大的数学兼容性，后续文章的编辑主要依靠**StackEdit（在线）**和**Mou（本地）**完成。这里将展示如何用 **StackEdit**编写：
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE2MzQ3Nzc1LDE2ODYzNzM3MjcsMTQxMz
